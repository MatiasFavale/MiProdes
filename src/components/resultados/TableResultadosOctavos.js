...
const TableResultadosOctavos = ({matches ,  errors = {}, onChange, onSaveClick, onDisableClick, onSavePointsUser, activeItem, OC1, OC2, OC3, OC4}) => {
  return (
    <>
...
TableResultadosOctavos.propTypes = {
...
export default TableResultadosOctavos;