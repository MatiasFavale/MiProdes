...
const TableFixtureFinals = ({matches ,  errors = {}, onChange, onSaveClick, onDisableClick, onSavePointsUser, activeItem, FNS}) => {
  return (
    <>
        <table className="table table-striped table-bordered table-hover table-dark tableFinalesHeight">
            <thead>
              <tr>
                <th>Fecha</th>
                <th>EquipoL</th>
